...
import com.wmcalyj.eashtracking.barcodereader.BarcodeCaptureActivity;
import com.wmcalyj.eashtracking.service.FileService;
import com.wmcalyj.eashtracking.service.RequestService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button check, cancel, clear, scan;
...
//        setSupportActionBar(toolbar);
        ...
        editText = ((EditText) findViewById(R.id.tracking_number));
        editText.setFilters(getWhiteSpaceFilters());
        ...
        scan = (Button) findViewById(R.id.barcode_scanner_button);
    ...
    private InputFilter[] getWhiteSpaceFilters() {
        InputFilter[] filters = new InputFilter[1];
        filters[0] = getWhiteSpaceFilter();
        return filters;
    }
            ...
            public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int
                ...
                for (int i = start; i < end; i++) {
                    if (Character.isWhitespace(source.charAt(i))) {
                        Toast.makeText(mContext, R.string.white_space_warning, Toast.LENGTH_LONG)
                                .show();
                        return "";
                    }
                }
...
//                    Log.d(TAG, "No barcode captured, intent data is null");
                    Toast.makeText(this, "No barcode captured, intent data is null", Toast
                            .LENGTH_LONG);
                }
            } else {
